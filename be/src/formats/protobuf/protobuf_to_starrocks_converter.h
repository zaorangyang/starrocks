...
// just append data
template<typename PbType, typename LocalType>
class AppendPbConverter final : public PbConverter<PbType, LocalType> {
public:
...
// string to string
template<typename PbType, typename LocalType>
class StringPbConverter final : public PbConverter<PbType, LocalType> {
public:
...
template<typename PbType, typename LocalType>
class Decimalv2PbConverter final : public PbConverter<PbType, LocalType> {
public:
...
template<typename PbType, typename LocalType>
class Decimalv3PbConverter final : public PbConverter<PbType, LocalType> {
public:
    ...
    bool convert_func(Column* column, PbType pbData, bool strict_mode, int decimal_scale) {
        ...
        LocalType dec_value;
        bool overflow = DecimalV3Cast::from_integer<PbType, LocalType, true>(pbData, decimal_scale, &dec_value);
        if (overflow) {
            if (strict_mode) {
                return false;
            }
...
template<typename PbType, typename LocalType>
class Decimalv2FloatPbConverter final : public PbConverter<PbType, LocalType> {
public:
    bool convert_func(Column* column, PbType pbData) {
...
template<typename PbType, typename LocalType>
class Decimalv2DoublePbConverter final : public PbConverter<PbType, LocalType> {
public:
    bool convert_func(Column* column, PbType pbData) {
...
template<typename PbType, typename LocalType>
class Decimalv3FloatDoublePbConverter final : public PbConverter<PbType, LocalType> {
public:
    bool convert_func(Column* column, PbType pbData, bool strict_mode, int decimal_scale) {
        auto decimalv3_column = down_cast<DecimalV3Column<LocalType>*>(column);
        LocalType dec_value;
        bool overflow = DecimalV3Cast::from_float<PbType, LocalType, true>(pbData, decimal_scale, &dec_value);
        if (overflow) {
            if (strict_mode) {
                return false;
            }
...
template<typename PbType, typename LocalType>
class IntegerToIntegerPbConverter final : public PbConverter<PbType, LocalType> {
public:
...
template<typename PbType, typename LocalType>
class FloatToIntegerPbConverter final : public PbConverter<PbType, LocalType> {
public:
    bool convert_func(Column* column, PbType pbData, bool strict_mode) {
        bool overflow = false;
...
extern const std::unordered_map<google::protobuf::FieldDescriptor::CppType, std::unordered_map<LogicalType, PbConverter>> pb_conver_map;
