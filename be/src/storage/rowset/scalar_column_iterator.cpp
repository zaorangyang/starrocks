...
Status ScalarColumnIterator::init(const ColumnIteratorOptions& opts) {
    ...
    case TYPE_DOUBLE:
        ...
        break;
    case TYPE_DATE_V1:
        _init_dict_decoder_func = &ScalarColumnIterator::_do_init_dict_decoder<TYPE_DATE_V1>;
        break;
    case TYPE_DATE:
        _init_dict_decoder_func = &ScalarColumnIterator::_do_init_dict_decoder<TYPE_DATE>;
        break;
    case TYPE_DATETIME_V1:
        _init_dict_decoder_func = &ScalarColumnIterator::_do_init_dict_decoder<TYPE_DATETIME_V1>;
        break;
    case TYPE_DATETIME:
